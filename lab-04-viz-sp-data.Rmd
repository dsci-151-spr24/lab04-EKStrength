...
Each row contains the data for a Denny's restaurant. The variables are `r names(dennys)`.
...
Each row contains the data for a Laquinta hotel. The variables are `r names(laquinta)`.
...
***La Quinta hotels are mostly in the U.S. but also have locations in other parts of the world.***

***Denny's is only located in the U.S.***
...
***We can use the state variable to determine what location is in the U.S., specifically, by comparing the state listed to the data base of states in the U.S.***
...
***There are no Dennys locations outside the U.S. in our data.***
...
***Delaware and Washington D.C. have the fewest Denny's and California, Texas, and Florida have the most.***

***Texas has the most La Quinta's and Maine and Vermont have the least.***
